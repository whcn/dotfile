...
(defun dotspacemacs/user-config ()
  ...
  ;; (use-package cuda-mode :defer t) ;;cuda语法高亮
  ;; (add-to-hooks 'c-mode '(cuda-mode-hook))
  ;; ----------------------------------------------------
  ...
  ;; ----------------------------------------------------
  (setq org-log-done 'time) ;;记录TODO项完成的时间
  ;; ----------------------------------------------------
  (global-set-key "\C-cl" 'org-store-link)
  (global-set-key "\C-cc" 'org-capture) ;;capture
  ...
  (spacemacs/set-leader-keys "o w" 'youdao-dictionary-search-at-point+) ;;查单词
  (spacemacs/set-leader-keys "o v" 'youdao-dictionary-play-voice-at-point) ;;单词发音
  (spacemacs/set-leader-keys "o j" 'ace-pinyin-jump-char) ;;快速跳转
...
(custom-set-variables
 ...
 '(pyim-dicts
   (quote
    ((:name "BigDict-01" :file "/home/wh/.emacs.d/.cache/pyim-bigdict.pyim" :coding utf-8-unix :dict-type pinyin-dict))))
